...
def run_game_scene(screen, clock):
    ...
    notes_data = [
        ...
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 0, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 2, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 2 + eighth_ms * 1, "lane":1}, 
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 3 + eighth_ms * 0, "lane":3},

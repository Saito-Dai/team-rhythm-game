...
def run_game_scene(screen, clock):
    ...
    notes_data = [
        ...
        {"time": START_DELAY_MS + bar_ms * 20 + quarter_ms * 3, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 20 + quarter_ms * 3 + sixteenth_ms, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 20 + quarter_ms * 3 + sixteenth_ms * 2, "lane":2},
        ...
        {"time": START_DELAY_MS + bar_ms * 42 + quarter_ms * 0 + eighth_ms * 1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 42 + quarter_ms * 2 + eighth_ms * 2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 42 + quarter_ms * 3 + eighth_ms * 1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 43 + quarter_ms * 0 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 43 + quarter_ms * 2 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 43 + quarter_ms * 3 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 44 + quarter_ms * 0 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 44 + quarter_ms * 2 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 44 + quarter_ms * 3 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 45 + quarter_ms * 0 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 45 + quarter_ms * 2 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 45 + quarter_ms * 3 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 46 + quarter_ms * 0 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 46 + quarter_ms * 2 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 46 + quarter_ms * 3 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 47 + quarter_ms * 0 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 47 + quarter_ms * 2 + eighth_ms * 2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 47 + quarter_ms * 3 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 48 + quarter_ms * 0 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 48 + quarter_ms * 2 + eighth_ms * 2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 48 + quarter_ms * 3 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 49 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 49 + quarter_ms * 2 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 49 + quarter_ms * 3 + eighth_ms*1, "lane": 0},
        
        {"time": START_DELAY_MS + bar_ms * 50 + quarter_ms * 1, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 50 + quarter_ms * 2, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 50 + quarter_ms * 3, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 50 + quarter_ms * 3 + eighth_ms * 1, "lane":1}, 
        {"time": START_DELAY_MS + bar_ms * 50 + quarter_ms * 3 + eighth_ms * 2, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 51 + quarter_ms * 1, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 51 + quarter_ms * 2, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 51 + quarter_ms * 3, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 51 + quarter_ms * 3 + eighth_ms * 1, "lane":1}, 
        {"time": START_DELAY_MS + bar_ms * 51 + quarter_ms * 3 + eighth_ms * 2, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 52 + quarter_ms * 1, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 52 + quarter_ms * 2, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 52 + quarter_ms * 3, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 52 + quarter_ms * 3 + eighth_ms * 1, "lane":2}, 
        {"time": START_DELAY_MS + bar_ms * 52 + quarter_ms * 3 + eighth_ms * 2, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 53 + quarter_ms * 1, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 53 + quarter_ms * 2, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 53 + quarter_ms * 3, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 53 + quarter_ms * 3 + eighth_ms * 1, "lane":0}, 
        {"time": START_DELAY_MS + bar_ms * 53 + quarter_ms * 3 + eighth_ms * 2, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 54 + quarter_ms * 1, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 54 + quarter_ms * 2, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 54 + quarter_ms * 3, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 54 + quarter_ms * 3 + eighth_ms * 1, "lane":3}, 
        {"time": START_DELAY_MS + bar_ms * 54 + quarter_ms * 3 + eighth_ms * 2, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 55 + quarter_ms * 1, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 55 + quarter_ms * 2, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 55 + quarter_ms * 3, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 55 + quarter_ms * 3 + eighth_ms * 1, "lane":2}, 
        {"time": START_DELAY_MS + bar_ms * 55+ quarter_ms * 3 + eighth_ms * 2, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 56 + quarter_ms * 1, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 56 + quarter_ms * 2, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 56 + quarter_ms * 3, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 56 + quarter_ms * 3 + eighth_ms * 1, "lane":2}, 
        {"time": START_DELAY_MS + bar_ms * 56 + quarter_ms * 3 + eighth_ms * 2, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 57 + quarter_ms * 1, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 57 + quarter_ms * 2, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 57 + quarter_ms * 3, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 57 + quarter_ms * 3 + eighth_ms * 1, "lane":3}, 
        {"time": START_DELAY_MS + bar_ms * 57 + quarter_ms * 3 + eighth_ms * 2, "lane":1},
        
        #ここから笛
        {"time": START_DELAY_MS + bar_ms * 58 + quarter_ms * 0 + eighth_ms * 1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 58 + quarter_ms * 2 + eighth_ms * 2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 58 + quarter_ms * 3 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 59 + quarter_ms * 0 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 59 + quarter_ms * 2 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 59 + quarter_ms * 3 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 60 + quarter_ms * 0 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 60 + quarter_ms * 2 + eighth_ms*2,"lane": 1},
        {"time": START_DELAY_MS + bar_ms * 60 + quarter_ms * 3 + eighth_ms *1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 61 + quarter_ms * 0 + eighth_ms * 1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 61 + quarter_ms * 2 + eighth_ms * 2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 61 + quarter_ms * 3 + eighth_ms * 1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 62 + quarter_ms * 1, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 62 + quarter_ms * 3, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 62 + quarter_ms * 3 + eighth_ms * 1, "lane":2}, 
        {"time": START_DELAY_MS + bar_ms * 62 + quarter_ms * 3 + eighth_ms * 2, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 1, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 3, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 3 + eighth_ms * 1, "lane":1}, 
        {"time": START_DELAY_MS + bar_ms * 63 + quarter_ms * 3 + eighth_ms * 2, "lane":3},
        {"time": START_DELAY_MS + bar_ms * 64 + quarter_ms * 1, "lane":0},
        {"time": START_DELAY_MS + bar_ms * 64 + quarter_ms * 3, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 64 + quarter_ms * 3 + eighth_ms * 1, "lane":0}, 
        {"time": START_DELAY_MS + bar_ms * 64 + quarter_ms * 3 + eighth_ms * 2, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 65 + quarter_ms * 1, "lane":2},
        {"time": START_DELAY_MS + bar_ms * 65 + quarter_ms * 3, "lane":1},
        {"time": START_DELAY_MS + bar_ms * 65 + quarter_ms * 3 + eighth_ms * 1, "lane":2}, 
        {"time": START_DELAY_MS + bar_ms * 65 + quarter_ms * 3 + eighth_ms * 2, "lane":1},
        #連打
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 0 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 1 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 1 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 2 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 2 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 3 + eighth_ms * 1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 66 + quarter_ms * 3 + eighth_ms * 2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 0 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 1 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 1 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 2 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 2 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 3 + eighth_ms * 1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 67 + quarter_ms * 3 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 0 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 1 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 1 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 2 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 2 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 3 + eighth_ms * 1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 68 + quarter_ms * 3 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 0 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 1 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 1 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 2 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 2 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 3 + eighth_ms * 1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 69 + quarter_ms * 3 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 0 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 1 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 1 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 2 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 2 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 3 + eighth_ms * 1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 70 + quarter_ms * 3 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 0 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 1 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 1 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 2 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 2 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 3 + eighth_ms * 1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 71 + quarter_ms * 3 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 72 + quarter_ms * 0 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 72 + quarter_ms * 0 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 72 + quarter_ms * 1 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 72 + quarter_ms * 1 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 72 + quarter_ms * 2 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 72 + quarter_ms * 2 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 72 + quarter_ms * 3 + eighth_ms * 1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 72+ quarter_ms * 3 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 73 + quarter_ms * 0 + eighth_ms*1, "lane": 3},
        {"time": START_DELAY_MS + bar_ms * 73 + quarter_ms * 0 + eighth_ms*2, "lane": 2},
        {"time": START_DELAY_MS + bar_ms * 73 + quarter_ms * 1 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 73 + quarter_ms * 1 + eighth_ms*2, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 73 + quarter_ms * 2 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms * 73 + quarter_ms * 2 + eighth_ms*2, "lane": 1},
        {"time": START_DELAY_MS + bar_ms * 73 + quarter_ms * 3 + eighth_ms * 1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms *73 + quarter_ms * 3 + eighth_ms*2, "lane": 3},
        {"time": START_DELAY_MS + bar_ms *74 + quarter_ms * 0 + eighth_ms*1, "lane": 0},
        {"time": START_DELAY_MS + bar_ms *74 + quarter_ms * 0 + eighth_ms*1, "lane": 1},
        {"time": START_DELAY_MS + bar_ms *74 + quarter_ms * 0 + eighth_ms*1, "lane": 2},
        {"time": START_DELAY_MS + bar_ms *74 + quarter_ms * 0 + eighth_ms*1, "lane": 3}
